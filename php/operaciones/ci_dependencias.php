<?php
class ci_dependencias extends extension_ci
{
	//-------------------------------------------------------------------------
	function relacion()
	{
	...
	{
		$datos = toba::consulta_php('co_parametros')->get_dependencias();
	...
	function conf__form(extension_ei_formulario $form)
	{
		if ($this->relacion()->esta_cargada()) {
			$datos = $this->tabla('dependencias')->get();            
	...
	{
		$this->tabla('dependencias')->set($datos);
